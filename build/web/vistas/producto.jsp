    ...
    <body  class="text-dark" style="font-size:1.2em; font-family: Garamond,serif">    
            ...
            <div class="container-fluid"> 
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active text-light" aria-current="page" href="./vistas/producto.jsp">Principal</a>
                        </li>
                        <li class="nav-item">
                ...
                <a data-toggle="dropdown" href="#">                    
                    ...
                    <div class="btn-group mr-4">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="../index.jsp">Empleado</a></li>
                        </ul>
                </a>
            </div>
            </div>
        ...
        <footer class="text-white text-center text-lg-start mt-4" style="background:  linear-gradient(rgb(18,111,232) 70%, rgb(9,56,116)); border: solid 1px black;" id="footerdomiprotection">
            ...
            <div class="container p-4">
                ...
                <!--Grid row-->
                <a href="#headerdomiprotection" class="text-white"><i class="fas fa-redo-alt"></i></a>
            </div>
            <!-- Grid container -->
